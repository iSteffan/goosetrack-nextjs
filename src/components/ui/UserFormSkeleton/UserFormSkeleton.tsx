  ...
  return (
    ...
    >
      <div className="relative h-[653px] w-full rounded-[16px] bg-white px-[18px] pb-[40px] pt-[59px] dark:bg-blackAccentBg md:h-[854px] md:px-[175px] md:pt-[40px] xl:h-[752px] xl:px-[164px] xl:py-[60px]">
        ...
        <div
          data-theme="dark"
          className="absolute left-1/2 top-[-32px] w-[72px] translate-x-[-50%] md:relative md:left-0 md:top-0 md:mx-auto md:mb-[20px] md:w-[124px] md:transform-none xl:mb-[18px]"
        >
